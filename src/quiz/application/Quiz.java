...
"System.out.println(x++ + ++x);";
        ...
        opt1.setBackground(new Color(209, 242, 235));
        opt1.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt1);
        
        opt2=new JRadioButton();
        opt2.setBounds(180,350,500,50);
        opt2.setBackground(new Color(209, 242, 235));
        opt2.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt2);
        
        opt3=new JRadioButton();
        opt3.setBounds(180,400,500,50);
        opt3.setBackground(new Color(209, 242, 235));
        opt3.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt3);
        
        opt4=new JRadioButton();
        opt4.setBounds(180,450,500,50);
        opt4.setBackground(new Color(209, 242, 235));
        ...
        submit.setForeground(new Color(24, 106, 59));
